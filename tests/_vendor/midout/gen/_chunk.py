...
from tests._vendor.midout.gen._util import stim_circuit_with_transformed_coords
from tests._vendor.midout.gen._flow import Flow, PauliString
from tests._vendor.midout.gen._patch import Patch
from tests._vendor.midout.gen._tile import Tile
...
class Chunk:
    ...
    def verify(self):
        ...
        from tests._vendor.midout.gen._flow_verifier import FlowStabilizerVerifier
    ...
    def magic_init_chunk(self) -> 'Chunk':
        ...
        """
        from tests._vendor.midout.gen._flow_util import magic_init_for_chunk
    ...
    def magic_end_chunk(self) -> 'Chunk':
        ...
        no care for connectivity or physical limitations of hardware.
        """
        from tests._vendor.midout.gen._flow_util import magic_measure_for_chunk
